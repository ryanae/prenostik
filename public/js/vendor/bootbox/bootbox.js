...
var bootbox = window.bootbox || (function(document, $) {
    ...
    that.prompt = function(/*str, labelCancel, labelOk, cb, defaultVal*/) {
        ...
        var confirmCallback = function() {
            if (typeof cb === 'function') {
                return cb(form.find("input[type=text]").val(), false);
            }
        };

        var customCallback = function() {
            if (typeof cb === 'function') {
                return cb(form.find("input[type=text]").val(), true);
            }
        }
        ...
        var div = that.dialog(form, buttons, {
        ...
        // // HACK via Adrian 
        // if(worksheetNames){
        //     form.children('input').autocomplete({
        //           source: worksheetNames
        //     }); 
        // }
    ...
    that.dialog = function(str, handlers, options) {
        ...
        var parts = ["<div class='bootbox modal' tabindex='-1'>"];
